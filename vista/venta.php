...
<html lang="en">
  <head>
    ...
    <title>.:Sistema de Ventas IES:.</title>
 ...
 <body onload="mueveReloj()">
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href=""><img id="logotipo"src="../img/logo_2.png" alt=""></a>
        </div>
  ...
  <th id="thCodigo"class="tablaHeader">IdPro</th>
    <th id="thNombre"class="tablaHeader">Descripcion</th>
      <th id="thCant"class="tablaHeader">Cant</th>
        <th id="thPrecio"class="tablaHeader">P.Unitario</th>
     ...
     <tr>
        ...
        <td><select id="tipoN" name="tipo">
          <option value="">SELECCIONE</option>
            <option value="V-">N- LOCAL</option>
              <option value="J-">J- PROVINCIA</option>
...
<div class="modal fade" id="FinalizarVenta" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <center> <h4 class="modal-title" id="myModalLabel"> <img id="newuser"src="../img/fact.png" width="60px;"> <b id="titulo_fact"> .:FACTURA DIGITAL:.</b></h4></center>
      </div>
      <div class="modal-body">
      <center>
       <table width="80%" border="0" align="center">
         <tr>
           <th colspan="4"id="fact_aling"><h4>Instalaciones Electronicas de Seguridad</h4></th>
         </tr>
         <tr>
         <th colspan="4"id="fact_aling">Calle I. Manuel Altamarina 1001 Col Universidad</th>
            </tr>
            ...
            <tr>
             ...
             <tr>
              <td ><b>Cliente:</b><?php echo "&nbsp;&nbsp;".$cliente['nombre']."&nbsp;".$cliente['apellido']; ?></td>
               <td><b>RFC/CVE:</b><?php echo "&nbsp;&nbsp;".$cliente['cedula'] ?></td>
            </tr>
...
while($fact=$stm->fetch_array()) {  ?>
        ...
        <?php  }  ?>
              ...
              <td colspan="4"><center><b>-----------------------------------------------------------------------------------------------</b></center></td>
               ...
               <tr>
              <td><h4>TOTAL</h4></td>
                <td colspan="3" id="aling_right"><h4>MXN<?php echo "$&nbsp;&nbsp;".$total; ?> </h4></td>
               </tr>

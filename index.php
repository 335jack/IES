...
<html lang="es"><head>
    <meta charset="utf-8">
    <title>..::Login-Instalaciones Electronicas::..</title>
  ...
  <img id="img_index"  src="img/logo_2.png" alt="">
      </form>
  ...
  <h4>Bienvenido al Sistema</h4>
    ...
    <form action="seguridad/login.php" method="post"class="form-signin">
        ...
        <img src="img/login_1.png" id="login"alt="">
...
<?php 
 ...
 <b> <span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span>&nbsp;&nbsp;Los Datos proporcionados son incorrectos</b> 
</div>
<?php 	

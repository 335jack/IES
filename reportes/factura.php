...
$a=$pdf->Image('../img/logo_2.png',10,5,-200);
 $pdf->Cell(30);
$pdf->SetFont('Arial','B',15);
$pdf->Cell(80,10,"R.F.C.:5842621452",0,0,"C");

$pdf->Cell(80,10,"FECHA:  ".$tmp['fecha_venta'],1,1,"L");
$pdf->SetFont('Arial','i',12);
$pdf->Cell(30,7,"",0,0,"C");
 $pdf->Cell(80,7,"Av. I. Manuel Altamirano 1001",0,0,"C");
...
$pdf->Cell(30,7,"",0,0,"C");
 $pdf->Cell(80,7,"Colonia Iniversidad",0,1,"C");
 $pdf->Cell(30,7,"",0,0,"C");
 $pdf->Cell(80,7,"Toluca,Edo.Mex.",0,1,"C");

  $pdf->Cell(190,7,"	DATOS DEL CLIENTE",1,1,"C");

$pdf->SetFont('Arial','B',13);
  $pdf->Cell(31,6,"RFC/CVE:",1,0,"C");
...
$pdf->Cell(0,2,"",0,1,"C");
  ...
  $pdf->Cell(20,8,"CANT",1,0,"C");
    $pdf->Cell(100,8,"DESCRIPCION",1,0,"C");
      $pdf->Cell(35,8,"P.Unitario",1,0,"C");
